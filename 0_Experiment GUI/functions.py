...
def trials_organisarion (iid_csv,rdw_csv, trial_type):
    iid_shufl = iid_csv[:, np.random.RandomState(seed=43).permutation(iid_csv.shape[1])]
    rdw_shufl = rdw_csv[:, np.random.RandomState(seed=43).permutation(rdw_csv.shape[1])]
    ...
    if  trial_type ==1:
        ...
        stim_array_3 =  np.hstack([rdw[0], rdw[1], iid[0], iid[1], rdw[2], rdw[3], iid[2], iid[3],])
        return stim_array_3        
    elif trial_type == 4 :
        stim_array_4 =  np.hstack([iid[0], iid[1], rdw[0], rdw[1], iid[2], iid[3], rdw[2], rdw[3],])
        return stim_array_4 
    elif trial_type == 5 :
        stim_array_5 =  np.hstack([rdw[0], rdw[1], rdw[2], rdw[3],  iid[0], iid[1], iid[2], iid[3],])
        return stim_array_5
    elif trial_type == 6 :
        stim_array_6 =  np.hstack([iid[0], iid[1], iid[2], iid[3], rdw[0], rdw[1], rdw[2], rdw[3],])
        return stim_array_6
    elif trial_type == 7 :
        ...
        stim_array_9 =  np.hstack([rdw[0],  rdw[1],  iid[0],  iid[1],  rdw[2],  iid[2],  rdw[3],  iid[3], ])
        return stim_array_9    
    elif trial_type == 10 :
        stim_array_10 =  np.hstack([iid[0], iid[1], rdw[0], rdw[1], iid[2], rdw[2], iid[3], rdw[3],  ])
        return stim_array_10    
    elif trial_type == 11 :
        stim_array_11 =  np.hstack([rdw[0], iid[0], rdw[1], iid[1], rdw[2], rdw[3], iid[2],iid[3],])
